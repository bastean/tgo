...
func Init() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_Init_aa0f`,
		Function: `function __templ_Init_aa0f(){user = {
        "user_create" : "/v0/user",
        "user_read"   : "/v0/user",
        "user_update" : "/v0/user",
        "user_delete" : "/v0/user",
    ...
    $.api.settings.successTest = function(response) {
		...
		Call:       templ.SafeScript(`__templ_Init_aa0f`),
		CallInline: templ.SafeScriptInline(`__templ_Init_aa0f`),
	}
}
