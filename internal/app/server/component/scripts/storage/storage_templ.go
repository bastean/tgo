...
func Init() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_Init_a000`,
		Function: `function __templ_Init_a000(){const Storage = {
        MasterKey: "tgo",
        Key: {},
        Init() {
    ...
    window.Storage = Storage
		...
		Call:       templ.SafeScript(`__templ_Init_a000`),
		CallInline: templ.SafeScriptInline(`__templ_Init_a000`),
	}
}
